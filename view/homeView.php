...
<section class="section container">
    ...
    <div class="mt-1">
        ...
        <?php }
            ...
            <h1 class="m-4 text-center">Bienvenue aux délices des îles</h1>
        <?php } ?>

        <p class="text-center">
            Bonjour <?php if(isset($_SESSION['connect'])) { ?><b><?= $_SESSION['pseudo'] ?></b>
        <?php }
        else { ?>visiteur
        <?php } ?>, voici mon blog de recettes, que j'ai réalisé dans le cadre de ma formation de Développeur web.<br>
        </p>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <div class="row m-4 justify-content-center">
                        ...
                        <div class="col-2">
                            <img class="stacks" src="src/assets/logo/svg/PHP.svg" alt="Logo PHP">  
                        </div>
                        <div class="col-2">
                            <img class="stacks" src="src/assets/logo/svg/mysql.svg" alt="Logo MySQL">
                        </div>
                    </div>

                    <div class="row m-2 justify-content-center">
                        <div class="col-6">
                            <img class="stacks" src="src/assets/logo/svg/phpmyadmin.svg" alt="Logo PHPMyAdmin">
                        </div>
                    </div>
                </div>
            </div>
