...
<header class="header">
    <nav class="navbar navbar-expand-lg navbar-light p-2 m-0 rounded-5 rounded-top-0">
        <div class="container">
            <a class="navbar-brand p-2 logo" href="index.php?page=home">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav logo">
                ...
                <li class="nav-item">
                    <a href="index.php?page=recipes" class="nav-link">Nos recettes</a>
                </li>
                <?php if(!isset($_SESSION['connect'])) { ?>                        
                <li class="nav-item">
                    <a href="index.php?page=connection" class="nav-link">Se connecter</a>
                </li>
                <li class="nav-item">
                    <a href="index.php?page=registration" class="nav-link">S'inscrire</a>
                <?php }
